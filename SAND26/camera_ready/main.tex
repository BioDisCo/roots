...
\Copyright{Matthias Függer and Thomas Nowak} %TODO mandatory, please use full first names. LIPIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
...
\relatedversiondetails{Full version}{https://arxiv.org/abs/2602.19121}%optional, e.g. related papers in other conferences, pre-print server, or journal

\supplement{\url{https://github.com/BioDisCo/roots}}%optional, e.g. related research data, source code, ... hosted on a repository like zenodo, figshare, GitHub, ...
...
%(see \url{https://github.com/BioDisCo/verified-badges}).
