...
Some definitions and results have been formalized in the Lean~4 proof assistant using the Mathlib library. Results marked with \leanproof{} have machine-checked proofs; definitions and statements marked with \leanformalized{} have been formalized without a complete proof. These serve as supplementary certificates for our reasoning, not as replacements for the proofs in this paper. Clicking a badge links to the corresponding Lean source code.
