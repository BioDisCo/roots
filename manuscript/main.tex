...
Results marked with \leanproof{} have machine-checked proofs; definitions and statements marked with \leanformalized{} have been formalized without a complete proof (see \url{https://github.com/BioDisCo/verified-badges}).
...
The following lemma establishes a lower bound on this distance (Figure~\ref{fig:panel_2}a); its proof is given in the Appendix.
...
The following two lemmas on concave functions are proved in the Appendix.
...
and all node values; the proof is given in the Appendix.
