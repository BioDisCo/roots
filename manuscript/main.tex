...
\begin{figure}[hpt]
    ...
    Animated (\href{\suppurl{Movie_S1_execution_1_root_animation.mp4}}{Movie~S1}, \href{\suppurl{Movie_S2_execution_2_roots_animation.mp4}}{S2}, \href{\suppurl{Movie_S3_execution_3_roots_animation.mp4}}{S3}) and interactive (\href{\suppurl{Document_S1_execution_1_root_execution.html}}{Document~S1}, \href{\suppurl{Document_S2_execution_2_roots_execution.html}}{S2}, \href{\suppurl{Document_S3_execution_3_roots_execution.html}}{S3}) versions of \textbf{b--d} are provided as supplementary material.
    ...
    An animated execution oscillating on a $1$-dimensional subspace is provided as \href{\suppurl{Movie_S4_execution_oscillating_on_1d_animation.mp4}}{Movie~S4} and \href{\suppurl{Document_S4_execution_oscillating_on_1d_execution.html}}{Document~S4}.
    }
    \label{fig:panel_1}
\end{figure}
