...
Results marked with \leanproof{} have been formally verified in the Lean~4 proof assistant using the Mathlib library; results marked with \leanformalized{} have their statements formalized. Clicking the badge links to the corresponding Lean source code.
