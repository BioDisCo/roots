...
\newcommand{\leanproof}[1]{%
  \href{#1}{\raisebox{-2pt}{\includegraphics[height=1.2em]{lean-verified-badge.pdf}}}%
}
...
Results marked with \leanproof{} have been formally verified in the Lean~4 proof assistant using the Mathlib library; clicking the badge links to the corresponding Lean source code.
...
\begin{theoremrep}[\leanproof{https://github.com/you/repo/Diamond.lean}]\label{lem:imposs}
...
\begin{definition}[Minimum broadcasting weight]
...
\begin{lemmarep}[\leanproof{https://github.com/you/repo/Diamond.lean}]\label{lem:halfspace:distance:formula}
...
\begin{lemmarep}\label{lem:halfspace:zone}
...
\begin{lemmarep}[\leanproof{https://github.com/you/repo/Diamond.lean}]\label{lem:concave:line}
...
\begin{lemmarep}[\leanproof{https://github.com/you/repo/Diamond.lean}]\label{lem:concave:line:zero}
Let $a,b,c \in \IR$ with $a<b<c$
...
\begin{lemmarep}\label{lem:volumes}
...
\begin{lemmarep}\label{lem:convex:zero:hyperplane}
...
\begin{theorem}\label{thm:solving}
Let $d \geq k \geq 1$.
...
\begin{lemmarep}[\leanproof{https://github.com/you/repo/Diamond.lean}]\label{lem:xi_xip}
...
\begin{lemma}[\leanproof{https://github.com/you/repo/Diamond.lean}]\label{lem:differences}
...
\begin{definition}[Projection $\Pi_t$ and Thickness $\Delta$]\label{def:thickness}
...
\begin{lemma}\label{lem:accumulation_point}
...
\begin{lemmarep}\label{lem:continuity}
...
\begin{lemma}[Contraction of thickness]
