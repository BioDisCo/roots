...
Since the sets~$P(t)$ are nonincreasing for any averaging algorithm, this equivalent to the limit set $P^* = \lim_{t\to\infty} P(t) = \bigcap_{t\geq 0} P(t)$ being contained in some affine hyperplane $E\subseteq \IR^d$.
...
0
\end{equation}
for infinitely many~$t$ where $\vol_E(P^*)$ denotes the $(d-1)$-dimensional volume of~$P^*$ as a subset of the hyerplane~$E$.
