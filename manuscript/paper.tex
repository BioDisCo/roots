...
\begin{itemize}
\item There exists an affine hyperplane $H\subseteq \IR^d$ such that all sequences $\big(x_i(t)\big)_t$ converge onto~$H$.
...
\end{algorithmic}
\caption{Averaging algorithm for agent $i$}
\label{alg:averaging}
\end{algorithm}
